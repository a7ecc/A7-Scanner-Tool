...
echo                         IP Address : %ip%.%TargetIP%
echo.
echo.
if not exist "A7 Scanner Tool Results" md "A7 Scanner Tool Results"
nmap -sV "%ip%.%TargetIP%"> "A7 Scanner Tool Results\%ip%.%TargetIP%.txt"
type "A7 Scanner Tool Results\%ip%.%TargetIP%.txt"
...
set search=%search: =+%
start https://www.rapid7.com/db/?q=%search%^&type=nexpose
goto research
:restart
cls
echo  +---------------------------------------------------------------------+
